...
tikz_replacements_unitful <- function() {
    c(delta.F = "$\\Delta F$ (W~m$^{-2}$)",
      ...
      skw = "Sk$_w$",
      delta.theta = "$\\thetal^+ - \\langle\\thetal\\rangle$ (K)",
      delta.q = "$\\qt^+ - \\langle \\qt \\rangle$ (kg~kg$^{-1}$)",
      E = "$E$ (kg~m$^{-2}$~s$^{-1}$)",
      E_theta = "$E_\\theta$ (kg~m$^{-2}$~s$^{-1}$)",
      E_q = "$E_q$ (kg~m$^{-2}$~s$^{-1}$)",
      E_theta.delta.theta = "$E_\\theta(\\thetal^+ - \\langle\\thetal\\rangle)$ (kg~K~m$^{-2}$~s$^{-1}$)",
      E_q.delta.q = "$E_q(\\qt^+ - \\langle \\qt \\rangle)$ (kg~m$^{-2}$~s$^{-1}$)",
      E_theta.delta.theta.hatted = "$E_\\theta(\\thetal^+ - \\hat\\theta_l)$ (kg~K~m$^{-2}$~s$^{-1}$)",
      E_q.delta.q.hatted = "$E_q(\\qt^+ - \\hat q_t)$ (kg~m$^{-2}$~s$^{-1}$)",
